...
export function StickyShareBar({ url, title }: StickyShareBarProps) {
      ...
      <div className="flex flex-col gap-1">
        ...
        >
          {copied ? (
            ...
            <svg className="h-5 w-5 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" title="Copy failed">
