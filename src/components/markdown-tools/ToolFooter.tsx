...
const tools = [
  ...
  { href: "/markdown-syntax", label: "Basic Syntax" },
  { href: "/markdown-extended-syntax", label: "Extended Syntax" },
  { href: "/markdown-guide", label: "Markdown Guide" },
  { href: "/markdown-hacks", label: "Hacks & Tips" },
