...
export function HeroRevamp() {
  return (
    <section className="relative min-h-[100dvh] w-full flex flex-col items-center justify-center overflow-hidden border-b border-border -mt-[72px] pt-[72px]">
      ...
      <div
        className="absolute top-0 left-0 -translate-y-1/4 -translate-x-1/4 w-[800px] h-[800px] rounded-full blur-[120px] opacity-20 bg-primary pointer-events-none"
        aria-hidden
      />
      <div
        className="absolute bottom-0 right-0 translate-y-1/4 translate-x-1/4 w-[600px] h-[600px] rounded-full blur-[120px] opacity-20 bg-primary pointer-events-none"
        aria-hidden
      />
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center animate-reveal">
        ...
        <h1 className="text-hero text-foreground max-w-[1000px] mx-auto text-balance mb-8">
          Your Med Spa Deserves an Agency That Builds Like It's 2026
        </h1>

        <p className="text-body text-muted-foreground max-w-[600px] mx-auto text-balance mb-12">
