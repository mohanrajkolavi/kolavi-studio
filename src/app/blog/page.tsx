              ...
              <div className="mt-14 inline-flex flex-col items-center gap-6 rounded-2xl bg-card px-8 py-6 shadow-sm ring-1 ring-border sm:flex-row sm:gap-10">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex gap-1.5">
                    ...
                    <a href="/blog/rss" className="rounded-full p-2 text-muted-foreground transition-colors hover:bg-muted hover:text-orange-600 dark:hover:text-orange-400" aria-label="RSS">
